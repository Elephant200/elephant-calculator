...
from elephant_calculator_api.models.pythagorean import PythagoreanTriplesRequest
from elephant_calculator.services.pythagorean import generate, generatePrimitive
