  ...
  // ===================== VECTORS =====================
  {
    ...
    operations: [
      ...
      },
      {
        id: "vec-magnitude",
        label: "Magnitude",
        blurb: "Euclidean length (norm) ‖v‖ of a vector.",
        endpoint: "/vectors/magnitude",
        fields: [vec("vector", "Vector", [3, 4])],
        result: "scalar",
        resultLabel: "Magnitude",
      },
      {
        id: "vec-normalize",
        label: "Normalize",
        blurb: "Unit vector pointing in the same direction.",
        endpoint: "/vectors/normalize",
        fields: [vec("vector", "Vector", [3, 4])],
        result: "vector",
        resultLabel: "Unit vector",
      },
      {
        id: "vec-distance",
        label: "Distance",
        blurb: "Euclidean distance between two points.",
        endpoint: "/vectors/distance",
        fields: [vec("vector1", "Point A", [1, 2, 3]), vec("vector2", "Point B", [4, 6, 8])],
        result: "scalar",
      ...
      },
      {
        id: "vec-angle",
        label: "Angle between",
        blurb: "Angle between two vectors, in degrees.",
        endpoint: "/vectors/angle",
        fields: [vec("vector1", "Vector A", [1, 0, 0]), vec("vector2", "Vector B", [1, 1, 0])],
        result: "scalar",
        resultLabel: "Angle (°)",
      },
      {
        id: "vec-projection",
        label: "Projection",
        blurb: "Vector projection of A onto B.",
        endpoint: "/vectors/projection",
        fields: [vec("vector1", "Vector A", [3, 4]), vec("vector2", "Vector B", [1, 0])],
        result: "vector",
