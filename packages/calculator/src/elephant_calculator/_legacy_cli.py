...
clear()
print(" - Loading os... DONE\n - Loading sys... DONE\n - Loading time... DONE\n - Loading sympy...\n - Loading files... ")
from elephant_calculator.services.cas import cas_cli
clear()
print(" - Loading os... DONE\n - Loading sys... DONE\n - Loading time... DONE\n - Loading sympy... DONE\n - Loading files... ")
from inputimeout import inputimeout
from elephant_calculator.services.geometry import area, perimeter, volume, surface_area
from elephant_calculator.services.vector import Vector
from elephant_calculator.services.matrix import Matrix
from elephant_calculator.services import triangle_solver as triangle
from elephant_calculator.services import irrationals as irr
from elephant_calculator.services import pythagorean as pythag
from elephant_calculator.services import primes as prime
from elephant_calculator.services import cas
clear()
print(" - Loading os... DONE\n - Loading sys... DONE\n - Loading time... DONE\n - Loading sympy... DONE\n - Loading files... DONE")
clear()
...
try:
    with open(REVIEWS_DIR / "ratings.txt", 'r') as f: ratings = f.readline().strip().split(' ')
...
if input("Would you like to read the reviews? (y/n) ").startswith('y'):
    clear()
    with open(REVIEWS_DIR / "reviews.txt", 'r') as f:
        num = 0
            ...
            while True:
                ...
                if func.startswith('1'):
                    ...
                    while not input("Type STOP to stop.").upper().startswith('S'):
                        ...
                        with open(REVIEWS_DIR / "ratings.txt", 'a') as f:
                            f.write(str(stars) + " ")
